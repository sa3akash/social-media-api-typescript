...
class PostRoutes {
  ...
  public routes(): Router {
    this.router.post('/post', authMiddleware.verifyUser, CreatePost.prototype.post);
    ...
    this.router.put('/post/:postId', authMiddleware.verifyUser, UpdatePostController.prototype.postUpdate);
