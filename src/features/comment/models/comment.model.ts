...
interface CommentModelType extends Model<ICommentDocument> {
...
CommentSchema.statics.getCommentsWithReplyCount = async function (postId: string, lastCreatedAt: Date | null, limit: number) {
...
export const CommentModel = mongoose.model<ICommentDocument, CommentModelType>('Comment', CommentSchema, 'Comment');
